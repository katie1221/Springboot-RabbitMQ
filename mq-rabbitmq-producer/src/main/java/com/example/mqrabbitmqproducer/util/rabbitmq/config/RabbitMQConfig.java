...
public class RabbitMQConfig {
    ...
    public AmqpTemplate amqpTemplate(){
         ...
         * config : 需要开启rabbitmq发送失败回退     yml配置publisher-returns: true    或rabbitTemplate.setMandatory(true);设置为true
         */
     ...
     */
    @Bean
    public Binding cancelOrderBinding(@Qualifier(RabbitMQConstantUtil.CANCEL_ORDER) Queue queue,@Qualifier(RabbitMQConstantUtil.DIRECT_EXCHANGE) Exchange directExchange){
     ...
     */
    @Bean
    public Binding confirmOrderBinding(@Qualifier(RabbitMQConstantUtil.CONFIRM_ORDER) Queue queue,@Qualifier(RabbitMQConstantUtil.DIRECT_EXCHANGE) Exchange directExchange){
        //RoutingKey :RabbitMQConstantUtil.CANCEL_ORDER,这里设置与消息队列 同名
